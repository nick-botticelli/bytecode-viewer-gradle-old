...
public class FileNavigationPane extends VisibleComponent implements
            ...
            if (ke.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                if (exact.isSelected()) {
                ...
                } else {
                    {
                        ...
                        Enumeration<MyTreeNode> enums = (Enumeration<MyTreeNode>)(Object)curNode.depthFirstEnumeration();
    ...
    private void showPopMenu(MyTree tree, TreePath selPath, int x, int y) {
        ...
        pop.add(new AbstractAction("Remove") {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selPath != null) {
                    ...
                    Enumeration<TreeNode> enumeration = treeRoot.children();
        ...
        pop.add(new AbstractAction("Expand", (Icon) UIManager.get("Tree.expandedIcon")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                TreePath selPath = FileNavigationPane.this.tree.getPathForLocation(x, y);
        ...
        pop.add(new AbstractAction("Collapse", (Icon) UIManager.get("Tree.collapsedIcon")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                TreePath selPath = FileNavigationPane.this.tree.getPathForLocation(x, y);
    ...
    public static class MyTreeNode extends DefaultMutableTreeNode {
        ...
        private void recursiveSort(final MyTreeNode node) {
            ((Vector<MyTreeNode>)(Object) node.children).sort(nodeComparator);

            for (MyTreeNode nextNode : (Iterable<MyTreeNode>)(Object) node.children) {
        ...
        protected Comparator<MyTreeNode> nodeComparator = new Comparator<>() {
            @Override
